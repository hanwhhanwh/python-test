...
(
	...
	, `script_name`			VARCHAR(100) NOT NULL COMMENT '자막 파일 이름' COLLATE 'utf8mb4_unicode_ci'
	, `file_size`			INT NOT NULL COMMENT '스크립트 파일 크기'
	, `script_path`			VARCHAR(100) NOT NULL COMMENT '자막 파일 저장 경로' COLLATE 'utf8mb4_unicode_ci'
