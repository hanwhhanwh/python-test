...
if __name__ == '__main__':
	...
	parser.add_argument('--img', type=str, default=IMG_PATH)
	...
	np.save('../results/onnx_yolov5_0.npy', outputs[0])
	np.save('../results/onnx_yolov5_1.npy', outputs[1])
	np.save('../results/onnx_yolov5_2.npy', outputs[2])
	print('done')
	...
	if boxes is not None:
		...
		cv2.imwrite('../results/bus_yolo5s_result.jpg', img_1)
